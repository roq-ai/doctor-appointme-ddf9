  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless healthcare with Doctor Appointment System, your gateway to easy and convenient online medical consultations and scheduling."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare with Doctor Appointment System, your gateway to easy and convenient online medical consultations and scheduling.`}
            </Text>
            <Box
